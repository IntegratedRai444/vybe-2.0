...
class SettingsService:
    ...
    def load_workspace_settings(self, workspace_path: str) -> Dict[str, Any]:
        ...
        try:
            workspace_settings_path = Path(workspace_path) / self.workspace_settings_file
    ...
    def save_workspace_settings(self, workspace_path: str, settings: Dict[str, Any]) -> bool:
    ...
    def update_workspace_setting(self, workspace_path: str, key_path: str, value: Any) -> bool:
