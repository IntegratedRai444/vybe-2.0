...
def chat():
    ...
    try:
        if provider == 'ollama':
            response = handle_ollama_request(provider_config, model, messages, temperature)
        elif provider == 'openai':
            response = handle_openai_request(provider_config, model, messages, temperature)
        elif provider == 'anthropic':
            response = handle_anthropic_request(provider_config, model, messages, temperature)
        elif provider == 'groq':
            response = handle_groq_request(provider_config, model, messages, temperature)
        else:
...
def handle_ollama_request(config: Dict[str, Any], model: str, messages: list, temperature: float) -> Dict[str, Any]:
...
def handle_openai_request(config: Dict[str, Any], model: str, messages: list, temperature: float) -> Dict[str, Any]:
...
def handle_anthropic_request(config: Dict[str, Any], model: str, messages: list, temperature: float) -> Dict[str, Any]:
...
def handle_groq_request(config: Dict[str, Any], model: str, messages: list, temperature: float) -> Dict[str, Any]:
