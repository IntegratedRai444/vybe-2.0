...
class NvidiaProvider(BaseModelProvider):
    ...
    async def _make_request(self, model: str, endpoint: str, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def embed(self, text: str, model: str = "nomic-ai/nomic-embed-text-v1.5") -> List[float]:
