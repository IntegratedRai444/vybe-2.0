...
from config.nvidia_config import DEFAULT_NVIDIA_MODEL, NVIDIA_MODEL_CONFIGS
...
class NvidiaProvider(AIProvider):
    ...
    def __init__(self, api_keys: Optional[Dict[str, str]] = None):
        ...
        self.available_models = [
            model_id for model_id in self.model_configs if self.api_keys.get(model_id)
        ]
    ...
    def _get_model_config(self, model_id: str) -> Dict[str, Any]:
        ...
        return {**self.model_configs[model_id], "api_key": self.api_keys[model_id]}
