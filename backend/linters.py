...
class CodeLinter:
    ...
    def lint_file(self, file_path: str, project_root: str) -> Dict[str, Any]:
        ...
        try:
            path = Path(file_path)
            if not path.exists():
                return {"diagnostics": [], "error": "File not found", "success": False}
    ...
    def lint_project(self, project_root: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for file_path in project_path.rglob("*"):
                if file_path.is_file() and not self.should_ignore_file(
    ...
    def basic_js_lint(self, content: str) -> Dict[str, Any]:
        ...
        return {"diagnostics": diagnostics, "success": True, "linter_used": "basic-js"}
    ...
    def lint_json(
        ...
        return {"diagnostics": diagnostics, "success": True, "linter_used": "json"}
    ...
    def lint_html(
        ...
        return {"diagnostics": diagnostics, "success": True, "linter_used": "html"}
    ...
    def lint_css(
        ...
        return {"diagnostics": diagnostics, "success": True, "linter_used": "css"}
