...
class GitWebSocketService:
    ...
    async def stage_files(self, paths: List[str]) -> None:
        ...
        try:
            ...
            await self._emit_event(
                ...
                {"repository": self.repo_path, "files": paths, "action": "staged"},
            )
    ...
    async def unstage_files(self, paths: List[str]) -> None:
        ...
        try:
            ...
            await self._emit_event(
                GitEventTypes.STAGE_CHANGED,
                {"repository": self.repo_path, "files": paths, "action": "unstaged"},
            )
    ...
    async def create_branch(self, name: str, checkout: bool = True) -> GitBranch:
        ...
        try:
            ...
            await self._emit_event(
                ...
                BranchEventData(
                    repository=self.repo_path, branch_name=name, is_current=checkout
                ).dict(),
            )
        ...
        try:
            ...
            if is_branch:
                ...
                await self._emit_event(
                    ...
                    BranchEventData(
                        repository=self.repo_path, branch_name=ref, is_current=True
                    ).dict(),
                )
