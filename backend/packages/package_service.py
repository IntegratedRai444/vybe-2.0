...
class PackageService:
    ...
    async def _emit_event(self, event_type: str, data: Dict[str, Any], channel: str = "packages"):
        ...
        try:
            ...
            await self._emit_event(
                ...
                PackageUninstallData(
                    package_name=package_name,
                    success=success,
                    message=f"Successfully uninstalled {package_name}" if success else f"Failed to uninstall {package_name}"
                ).dict()
            )
    ...
    async def list_installed(self, project_root: str, language: str) -> List[Dict[str, Any]]:
    ...
    async def list_outdated(self, project_root: str, language: str) -> List[Dict[str, Any]]:
