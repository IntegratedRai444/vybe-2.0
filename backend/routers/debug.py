...
import uuid
import asyncio
from ...debugger_service import debugger_service, DebugSession
...
class ConnectionManager:
    ...
    def disconnect(self, client_id: str, session_id: str):
        ...
        if session_id in self.session_connections and client_id in self.session_connections[session_id]:
