...
function getImports(filePath) {
  ...
  try {
    ...
    const jsxContent = transformSync(content, {
...
async function findUnusedFiles() {
  ...
  try {
    ...
    try {
      ...
      execSync('npm install --save-dev @babel/parser @babel/traverse @babel/core @babel/preset-react @babel/plugin-syntax-jsx', {
        cwd: PROJECT_ROOT,
        stdio: 'inherit'
      });
    }
    ...
    allFiles.forEach(file => {
      fileUsage.set(file, { 
        used: false, 
        usedBy: [],
        isEntry: ['src/main.tsx', 'src/App.tsx', 'src/index.tsx', 'src/AppWrapper.tsx'].includes(file)
      });
    });
