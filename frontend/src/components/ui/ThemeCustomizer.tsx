...
import { FaPalette, FaSun, FaMoon, FaDesktop, FaSave, FaUndo, FaDownload, FaUpload, FaEye } from "react-icons/fa";
...
export const ThemeCustomizer: React.FC<Props> = ({ onThemeChange }) => {
  ...
  const colorProperties: ThemeColor[] = [
    { name: 'Background', property: 'background', value: '#1a1a1a', description: 'Main background color' },
    { name: 'Surface', property: 'surface', value: '#2d2d2d', description: 'Surface elements (panels, cards)' },
    { name: 'Surface Hover', property: 'surface-hover', value: '#3a3a3a', description: 'Surface elements on hover' },
    { name: 'Border', property: 'border', value: '#404040', description: 'Border color' },
    { name: 'Text', property: 'text', value: '#ffffff', description: 'Primary text color' },
    { name: 'Text Secondary', property: 'text-secondary', value: '#a0a0a0', description: 'Secondary text color' },
    { name: 'Accent', property: 'accent', value: '#007acc', description: 'Primary accent color' },
    { name: 'Accent Hover', property: 'accent-hover', value: '#005a9e', description: 'Accent color on hover' },
    { name: 'Success', property: 'success', value: '#4caf50', description: 'Success state color' },
    { name: 'Warning', property: 'warning', value: '#ff9800', description: 'Warning state color' },
    { name: 'Error', property: 'error', value: '#f44336', description: 'Error state color' },
    { name: 'Info', property: 'info', value: '#2196f3', description: 'Info state color' },
    { name: 'Selection', property: 'selection', value: '#264f78', description: 'Selection background' },
    { name: 'Highlight', property: 'highlight', value: '#ffff00', description: 'Highlight color' },
    { name: 'Sidebar', property: 'sidebar', value: '#252526', description: 'Sidebar background' },
    { name: 'Status Bar', property: 'statusbar', value: '#007acc', description: 'Status bar background' },
    { name: 'Editor Background', property: 'editor-bg', value: '#1e1e1e', description: 'Code editor background' },
    { name: 'Editor Text', property: 'editor-text', value: '#d4d4d4', description: 'Code editor text' },
    { name: 'Editor Line', property: 'editor-line', value: '#2d2d30', description: 'Code editor line numbers' },
    { name: 'Editor Cursor', property: 'editor-cursor', value: '#ffffff', description: 'Code editor cursor' },
    { name: 'Editor Selection', property: 'editor-selection', value: '#264f78', description: 'Code editor selection' },
    { name: 'Terminal Background', property: 'terminal-bg', value: '#0c0c0c', description: 'Terminal background' },
    { name: 'Terminal Text', property: 'terminal-text', value: '#cccccc', description: 'Terminal text' },
  ];
  ...
  useEffect(() => {
    ...
    // Load active theme
    const activeThemeId = localStorage.getItem('vybe-active-theme') || 'dark-default';
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  <div
                    ...
                    style={{ backgroundColor: customColors[color.property] || color.value }}
                    onClick={() => setShowColorPicker(color.property)}
                  />
                  <input
                    type="text"
                    value={customColors[color.property] || color.value}
                    onChange={(e) => updateCustomColors(color.property, e.target.value)}
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-8 gap-2 mb-4">
              {[
                ...
                '#ff8000', '#80ff00', '#0080ff', '#ff0080', '#80ffff', '#ffff80',
                '#400000', '#004000', '#000040', '#404000', '#400040', '#004040',
                '#ff4000', '#40ff00', '#0040ff', '#ff0040', '#40ffff', '#ffff40',
                '#007acc', '#4caf50', '#ff9800', '#f44336', '#2196f3', '#9c27b0',
                '#795548', '#607d8b', '#e91e63', '#3f51b5', '#00bcd4', '#8bc34a'
              ].map((color) => (
                <div
                  key={color}
