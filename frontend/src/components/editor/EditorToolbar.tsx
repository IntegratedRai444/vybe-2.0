...
export const EditorToolbar: React.FC<EditorToolbarProps> = ({
  ...
  return (
    <div className={`flex items-center justify-between p-2 bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 ${className}`}>
      ...
      <div className="flex space-x-2">
        ...
        <button
          ...
          className={`p-1.5 rounded-full ${isDebugging ? 'text-red-500' : 'text-gray-600 dark:text-gray-400'} hover:bg-gray-200 dark:hover:bg-gray-700`}
          title={isDebugging ? 'Stop Debugging' : 'Start Debugging'}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M4.5 3A1.5 1.5 0 003 4.5v11A1.5 1.5 0 004.5 17h11a1.5 1.5 0 001.5-1.5v-11A1.5 1.5 0 0015.5 3h-11zM7 6a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 11-2 0V8.414l-1.293 1.293a1 1 0 01-1.414-1.414L9.586 7H8a1 1 0 01-1-1zm1 7a1 1 0 100 2h4a1 1 0 100-2H8z" clipRule="evenodd" />
          </svg>
        </button>
      </div>
    </div>
