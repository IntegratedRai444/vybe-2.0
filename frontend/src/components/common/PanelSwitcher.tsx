...
type PanelType = 'analysis' | 'collaboration' | 'deploy' | 'mcp' | 'outline' | 
                 'problems' | 'security' | 'shortcuts' | 'snippets' | 'sync' | 'terminal';
...
export const PanelSwitcher: React.FC<PanelSwitcherProps> = ({
  ...
  const panels: Record<PanelType, React.ReactNode> = {
    analysis: <AnalysisButton projectRoot={projectRoot} currentFile={currentFile} />,
