...
const FileOperations: React.FC<FileOperationsProps> = ({ fileId, currentPath, onComplete }) => {
  const { currentProject, renameFile, moveFile, getFile, getFileByPath } = useProject();
