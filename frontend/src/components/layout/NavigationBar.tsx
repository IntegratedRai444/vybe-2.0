    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          onClick: () => console.log("Expand Selection"),
        },
        {
          label: "Shrink Selection",
          shortcut: "Ctrl+Shift+Left",
          onClick: () => console.log("Shrink Selection"),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          shortcut: "Ctrl+F5",
          onClick: () => console.log("Run Without Debugging"),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          shortcut: "Ctrl+Shift+`",
          onClick: () => console.log("Split Terminal"),
        },
      ],
    },
    {
  ...
  return (
    <div className="flex items-center h-8 bg-[#3c3c3c] text-[#cccccc] text-sm select-none border-b border-[#252526]">
      {menuItems.map((menuItem, index) => (
        <div
          key={index}
          className="relative group px-3 h-full flex items-center hover:bg-[#2a2d2e] cursor-default"
        >
          {menuItem.label}
          ...
          <div className="hidden group-hover:block absolute top-full left-0 bg-[#252526] min-w-48 shadow-lg z-50 border border-[#454545] py-1">
            {menuItem.items.map((item, itemIndex) => (
              ...
              >
                ...
                {item.shortcut && (
                  <span className="text-[#7a7a7a] text-xs ml-4">
                    {item.shortcut}
                  </span>
                )}
              </div>
