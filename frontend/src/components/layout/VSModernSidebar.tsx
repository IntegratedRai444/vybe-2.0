...
const VSModernSidebar: FC<VSModernSidebarProps> = ({ onFileSelect }) => {
  ...
  const processFileStructure = (folder: Folder, parentPath = ""): FileItem => {
    ...
    const item: FileItem = {
      ...
      extension:
        folder.type === "file"
          ? folder.name.split(".").pop()?.toLowerCase()
          : undefined,
    };
      ...
      ...(contextMenu.type === "file"
        ? [
            ...
            { label: "Rename", icon: <FiEdit2 size={14} />, onClick: () => {} },
            {
              ...
              onClick: () =>
                contextMenu.item && handleDeleteItem(contextMenu.item),
            },
          ]
        : [
            {
              ...
              onClick: () =>
                contextMenu.item && handleCreateFile(contextMenu.item.path),
            },
            {
              label: "New Folder",
              icon: <FiFolderPlus size={14} />,
              onClick: () =>
                contextMenu.item && handleCreateFolder(contextMenu.item.path),
            },
            {
              label: "Refresh",
