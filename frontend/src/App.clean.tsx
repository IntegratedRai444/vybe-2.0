...
const ProjectProvider = lazy(() =>
  import("@/contexts/ProjectContext").then((module) => ({
    default: module.ProjectProvider,
  })),
);
const GitProvider = lazy(() =>
  import("@/contexts/GitContext").then((module) => ({
    default: module.GitProvider,
  })),
);
...
const DebuggerProvider = lazy(() =>
  import("@/contexts/DebuggerContext").then((module) => ({
    default: module.DebuggerProvider,
  })),
);
const MCPProvider = lazy(() =>
  import("@/contexts/MCPContext").then((module) => ({
    default: module.MCPProvider,
  })),
);

// Lazy load main app routes
const AppRoutes = lazy(() =>
  import("@/AppRoutes").then((module) => ({ default: module.default })),
);
