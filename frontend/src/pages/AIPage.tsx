...
const AIPage: React.FC = () => {
  ...
  const renderMessage = (message: AIMessage) => {
    ...
    return (
      <div
        key={message.id}
        className={`group relative py-4 px-4 ${
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center mb-1">
              ...
              <span className="ml-2 text-xs text-gray-500">
                {messageTime} • {message.provider || "local"} •{" "}
        ...
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center p-6 text-center text-gray-400">
            ...
            <p className="max-w-md">
              Ask me anything about your code, and I'll do my best to assist
              you. I can help with debugging, explaining concepts, generating
              code, and more.
            </p>
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl">
              ...
              >
                ...
                <p className="text-sm text-gray-400">
                  Get detailed explanations for any code snippet
                </p>
              </button>
              <button
              ...
              >
                ...
                <p className="text-sm text-gray-400">
                  Create new code based on your requirements
                </p>
              </button>
              <button
