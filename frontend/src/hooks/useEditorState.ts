...
interface EditorState {
  ...
  occurrencesHighlight: boolean | 'singleFile' | 'multiFile' | 'multiFileNoSkipTrivia';
  ...
  suggestSelection: 'first' | 'recentlyUsed' | 'recentlyUsedByPrefix' | ((model: any, position: any, items: any[]) => number);
...
export const useEditorState = () => {
  ...
  const updateOptions = useCallback((options: Partial<EditorState>) => {
